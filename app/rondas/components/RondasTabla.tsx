...
// fechaIngreso llega como fecha pura (@db.Date -> medianoche UTC): se formatea en
// UTC para no correr el dia por la diferencia horaria con Bogota.
function fechaSolo(value: string | Date) {
